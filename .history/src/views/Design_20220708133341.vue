    ...
    <div class="main main-raised">
      <div class="section profile-content">
        <div class="container">
          ...
          <h3>Beaucoup de ces dessins représente un renard ou espèce proche; un de mes buts étant de faire la promotion de mon jeu où le personnage principal
             est un renard, j'essaie de perfectionner mon style en les dessinant pour pouvoir un jour réaliser la promotion de mon jeu moi-même.
          </h3>
