              ...
              <template slot="tab-pane-1">
                <div class="md-layout" style="width: 90%; margin: auto; 
                  ...
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    ...
                    <img @click="showModal(tabDrawings[1])" :src="getImgById('andrew','drawing')" class="rounded imageSmall" />
                  ...
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    ...
                    <img @click="showModal(tabDrawings[11])" :src="getImgById('lake-green','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[12])" :src="getImgById('swan','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[15])" :src="getImgById('logo','drawing')" class="rounded imageSmall" />
