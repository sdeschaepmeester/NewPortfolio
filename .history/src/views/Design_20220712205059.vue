  ...
  data() {
    return {
      ...
      tabDrawings: [
        ...
        { id: "fire", image: require("@/assets/img/drawing/mill.png"), name: "Fire training", description: "Un entrainement pour apprendre à dessiner une flamme... Bon, ce n'est pas le meilleur." },
        { id: "bubbles", image: require("@/assets/img/drawing/mill.png"), name: "Bubbles", description: "Mon premier essai de dessin de bulles." },
        { id: "ghost-fox", image: require("@/assets/img/drawing/mill.png"), name: "Ghost fox", description: "Spooky" },
        { id: "isle", image: require("@/assets/img/drawing/mill.png"), name: "Ile dans le ciel", description: "Ce dessin sera repris et des nuages seront ajoutés." },
