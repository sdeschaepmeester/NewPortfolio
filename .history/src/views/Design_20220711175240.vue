              ...
              <template slot="tab-pane-1">
                <div class="md-layout" style="width: 90%; margin: auto; 
                  ...
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    ...
                    <img @click="showModal(tabDrawings[1])" :src="getImgById('me-and-pets','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[2])" :src="getImgById('neon-fox','drawing')" class="rounded imageSmall" />
