              ...
              <template slot="tab-pane-1">
                <div class="md-layout" style="width: 90%; margin: auto; 
                  ...
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    <md-button @click="modalShowImage = true"><img :src="tabDrawings[0].image" class="rounded" /></md-button>
...
export default {
  ...
  data() {
    return {
      ...
      tabDrawings: [
        { image: require("@/assets/img/drawing/neon-fox.png"), name: "Neon fox", description: "Un entrainement pour apprendre à dessiner les néons."},
