              ...
              <template slot="tab-pane-1">
                <div class="md-layout" style="width: 90%; margin: auto; 
                  ...
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    <img @click="showModal(tabDrawings[0])" :src="getImgById('neon-fox','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[1])" :src="getImgById('logo','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[2])" :src="getImgById('knight-full','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[3])" :src="getImgById('meadow','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[13])" :src="getImgById('fox-pumpkin','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[17])" :src="getImgById('lake','drawing')" class="rounded imageSmall" />

                  </div>
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    <img @click="showModal(tabDrawings[4])" :src="getImgById('me-and-pets','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[5])" :src="getImgById('black-fox','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[6])" :src="getImgById('fox-moon','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[7])" :src="getImgById('fox-sunset','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[16])" :src="getImgById('mill','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[18])" :src="getImgById('fox-sketch','drawing')" class="rounded imageSmall" />
                  </div> 
                  <div class="md-layout-item ml-auto" style="margin: 15px">
                    <img @click="showModal(tabDrawings[8])" :src="getImgById('lake-tree','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[9])" :src="getImgById('fox-bubbles','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[11])" :src="getImgById('andrew','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[12])" :src="getImgById('swan','drawing')" class="rounded imageSmall" />
                    <img @click="showModal(tabDrawings[15])" :src="getImgById('lake-green','drawing')" class="rounded imageSmall" />
                  </div>
                </div>
              </template>
