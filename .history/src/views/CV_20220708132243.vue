      ...
      <div class="section profile-content">
        <div class="container">
          ...
          <div>
            <img
                :src="cvimg"
                alt="Retrouvez mon CV ici : https://www.linkedin.com/in/samantha-deschaepmeester/"
                class="img-raised img-fluid"
            />
            <br/><br/>
            <p>Vous pouvez également téléchargez mon CV depuis ma sélection LinkedIn disponible sur mon profil : <span style="fontWeight: bold">https://www.linkedin.com/in/samantha-deschaepmeester/</span></p>
            <br/>
          </div>
        </div>
      </div>
...
export default {
  ...
  props: {
    ...
    cvimg: {
      type: String,
      default: require("@/assets/img/CV_Deschaepmeester_Samantha.png")
    }
  },
  computed: {
    headerStyle() {
